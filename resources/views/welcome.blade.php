    ...
    <div class="flex flex-col">
        ...
        <div class="min-h-screen flex items-center justify-center">
            <div class="flex flex-col justify-around h-full">
                <div>
                    <h1 class="text-gray-600 font-light tracking-wider text-5xl mb-6">
                        Class OAuth
                    </h1>
                    <p class="my-12 text-gray-700">
                        This is just a demonstration site for a class I'm teaching.
                    </p>
                    <ul class="list-reset">
